...
describe("Route: Comment-Thread router", () => {
  ...
  describe(`ENDPOINT: '/comments'`, () => {
    ...
    getAuthHeadersHook();
    context("GET", () => {
      it("all comments when user is a dev", () => {
            ...
            expect(res.body.comments).to.deep.equal([
              {
                ...
                userName: "user_name2",
                comment: "comment1",
                createdDate: res.body.comments[0].createdDate,
              },
              {
                id: 2,
                bugName: "bug_name2",
                userName: "user_name2",
                comment: "comment2",
                createdDate: res.body.comments[1].createdDate,
              },
              {
                id: 3,
                bugName: "bug_name3",
                userName: "user_name3",
                comment: "comment3",
                createdDate: res.body.comments[2].createdDate,
              },
              {
                id: 4,
                bugName: "bug_name2",
                userName: "user_name1",
                comment: "comment4",
                createdDate: res.body.comments[3].createdDate,
              },
            ]);
          });
      });

      it("only user-comments when user is not a dev", () => {
        return supertest(app)
          .get(COMMENTS_EP)
  ...
  describe.skip("ENDPOINT: filter routes", () => {
    const filterRoutes = ["/comments/bug/:bugId", "/comments/user/:userName"];
